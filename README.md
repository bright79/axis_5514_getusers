...
This page shows the details of the vulnerability found in AXIS 5514 Camera, I hope AXIS can fix this bug as soon as possible, because some of such cameras are maybe still in use. 
...
<SOAP-ENV:Header></SOAP-ENV:Header><SOAP-ENV:Body><tds:GetUsersResponse><tds:User><tt:Username>root</tt:Username><tt:UserLevel>Administrator</tt:UserLevel></tds:User></tds:GetUsersResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>
